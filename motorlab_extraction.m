...
motor.slots = 18;
Ipk = 800;
v = [0.493;0.231;0.745]+rand*1e-4;    % [tp;yr;Br]
motor.mintorque = 250;
Mr_target = 35;
filename = ['C:\Users\eexjb5\Dropbox\Uni\PhD\Matlab\MotorDesign\MotorCAD_MATLAB_optimisation\' sprintf('%ds%dp_%dkgMr.mot',motor.slots,motor.poles,Mr_target)];
%%
[temperature, motor] = MotorCAD_singlesim(motor, Ipk, Mr_target, v, filename);
disp(motor)
...
file = 'C:\Users\eexjb5\Dropbox\Uni\PyCharmProjects\BikeSim\data_import\MotorLAB_export_Mr35.mat';
disp(file)
